...
baseline_paths = [
    ...
    'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_FC_multi_discriminate_target_False_wrmp_1_Cerrado_MA_skipconn_True/',
    
    #'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_Dense_multi_discriminate_target_True_wrmp_1_Cerrado_MA_skipconn_True/',
    #'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_Dense_multi_discriminate_target_False_wrmp_1_Cerrado_MA_skipconn_True/',
]
...
baseline_checkpoints = [
    ...
    #'checkpoint_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_Dense_multi_discriminate_target_True_wrmp_1_Amazon_PA_Cerrado_MA_skipconn_True/',
    #'checkpoint_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_Dense_multi_discriminate_target_False_wrmp_1_Amazon_PA_Cerrado_MA_skipconn_True/',
]
...
baseline_labels = [
    ...
    SharedParameters.formatted_multi_target_label("RO","MA","PA","MA") + " " + SharedParameters.EXPERIMENTS_LABELS[0],
    SharedParameters.formatted_multi_target_label("RO","MA","PA","MA") + "\n" + SharedParameters.EXPERIMENTS_LABELS[1],
    
    #SharedParameters.formatted_multi_target_label("RO","PA","MA") + "\n" + SharedParameters.EXPERIMENTS_LABELS[2],
...
Charts.create_all_charts(args, baseline_paths,baseline_labels,baseline_checkpoints,titles, map_file,metrics_file,num_samples,target,'results_tr_Cerrado_MA_classification_S_Cerrado_MA_T_Cerrado_MA/')
...
Charts.t_test(f'{baseline_labels[3]} vs Lower baseline',f1_mean[1],f1_std[1],f1_mean[3],f1_std[3], n=5)
Charts.t_test(f'{baseline_labels[4]} vs Lower baseline',f1_mean[1],f1_std[1],f1_mean[4],f1_std[4], n=5)