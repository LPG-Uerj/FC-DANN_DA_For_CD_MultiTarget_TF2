...
#map_file = f'{SharedParameters.DA_MULTI_SOURCE_FILE_TITLE}_Ts_MA_Eval_PA'
#metrics_file = f'Metrics_{SharedParameters.DA_MULTI_SOURCE_FILE_TITLE}_Ts_MA_Eval_PA'
