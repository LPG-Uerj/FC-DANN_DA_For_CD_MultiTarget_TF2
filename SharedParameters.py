...
SINGLE_TARGET_LABEL = 'DANN-DDA'
SINGLE_TARGET_AUDIT_LABEL = 'DANN-DDA Audit'
...
MULTI_TARGET_LABEL = 'DMDA Multi-target$^{1}$'
MULTI_SOURCE_LABEL = 'DMDA Multi-source$^{2}$'
...
FORMAT_SINGLE_TARGET_LABEL =            'Source {} | Target {} | Test {}\nDA Single-target'
...
formatted_single_target_label = lambda x, y: FORMAT_SINGLE_TARGET_LABEL.format(x, y, y)
