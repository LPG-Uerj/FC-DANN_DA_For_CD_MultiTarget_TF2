...
baseline_paths = [
    ...
    #'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_Dense_multi_discriminate_target_True_wrmp_1_Amazon_PA_skipconn_True/',
    #'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_Dense_multi_discriminate_target_False_wrmp_1_Amazon_PA_skipconn_True/',
]
...
baseline_labels = [
    ...
    SharedParameters.formatted_multi_target_label("RO","MA","PA","PA") + " " + SharedParameters.EXPERIMENTS_LABELS[0],
    SharedParameters.formatted_multi_target_label("RO","MA","PA","PA") + " " + SharedParameters.EXPERIMENTS_LABELS[1],
