...
labels = [
    ...
    '2-Tr: PA->MA, Ts: MA (domain adaptation single-target)',
    '3-Tr: PA->MA, Ts: PA (domain adaptation single-target)',
    '4-Tr: MA->PA, Ts: MA (domain adaptation single-target)',
    '5-Tr: PA,Ts: MA (Source only training)']
