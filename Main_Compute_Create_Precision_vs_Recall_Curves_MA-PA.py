...
labels.append('3-Tr: MA->PA, Ts: MA (domain adaptation single-target)')
labels.append('4-Tr: PA->MA, Ts: PA (domain adaptation single-target)')
labels.append('5-Tr: MA,Ts: PA (Source only training)')
