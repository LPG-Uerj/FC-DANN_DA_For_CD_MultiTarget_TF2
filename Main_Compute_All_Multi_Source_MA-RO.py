...
baseline_labels = [
    ...
    SharedParameters.formatted_multi_source_label('MA','PA','RO') + " " + SharedParameters.EXPERIMENTS_LABELS[0],
    SharedParameters.formatted_multi_source_label('MA','PA','RO') + " " + SharedParameters.EXPERIMENTS_LABELS[1],
]
