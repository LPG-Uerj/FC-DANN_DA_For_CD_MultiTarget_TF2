...
labels.append('3-Tr: MA->RO,PA, Ts: PA (domain adaptation multi-target)')
labels.append('4-Tr: MA->RO,PA(blcd) Ts: PA (domain adaptation multi-target)')
...
labels.append('7-Tr: MA,Ts: PA (Source only training)')
