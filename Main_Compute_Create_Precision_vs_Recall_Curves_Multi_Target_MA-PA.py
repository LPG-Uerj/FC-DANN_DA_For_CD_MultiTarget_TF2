...
single_target_path = 'results_tr_Cerrado_MA_to_Amazon_PA_domain_adaptation_DR_FC_single_Amazon_PA/'
...
if len(result_path) == 0:
    titles = 'X=MA, Y=PA->MA\n'
    map_file = 'Single_Target_Ts_MA_Eval_PA_'
    metrics_file = 'Metrics_Single_Target_Ts_MA_Eval_PA_'
    ...
    metrics_file = 'Metrics_Multi_Target_Ts_MA_Eval_PA_'
