...
single_target_path = 'results_tr_Cerrado_MA_to_Amazon_PA_domain_adaptation_CL_DR_single_Amazon_PA_wrmp1_gamma_2.5_skipconn_True/'
single_target_checkpoint = 'checkpoint_tr_Cerrado_MA_to_Amazon_PA_domain_adaptation_CL_DR_single_Amazon_PA_gamma_2.5_skipconn_True/'

result_path = [          
    'results_tr_Cerrado_MA_to_Amazon_RO_Amazon_PA_domain_adaptation_DR_FC_multi_discriminate_target_True_wrmp_1_Amazon_PA/'
...
checkpoint_list = [        
    'checkpoint_tr_Cerrado_MA_to_Amazon_RO_Amazon_PA_domain_adaptation_DR_FC_multi_discriminate_target_True_wrmp_1_Amazon_RO_Amazon_PA/'
...
if len(result_path) == 0:
    map_file = 'mAP_Ts_MA_Eval_PA_'
    metrics_file = 'metrics_Ts_MA_Eval_PA_'
    ...
    map_file = 'Multi_Target_Ts_MA_Eval_PA_'
    metrics_file = 'Metrics_Multi_Target__Ts_MA_Eval_PA_'
