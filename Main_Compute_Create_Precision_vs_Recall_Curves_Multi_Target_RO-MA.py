...
single_target_path = 'results_tr_Amazon_RO_to_Cerrado_MA_domain_adaptation_CL_DR_single_Cerrado_MA_wrmp1_gamma_2.5_skipconn_True/'
single_target_checkpoint = 'checkpoint_tr_Amazon_RO_to_Cerrado_MA_domain_adaptation_CL_DR_single_Cerrado_MA_gamma_2.5_skipconn_True/'


result_path = [   
    'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_FC_multi_discriminate_target_True_wrmp_1_Cerrado_MA/'
...
checkpoint_list = [    
    'checkpoint_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_FC_multi_discriminate_target_True_wrmp_1_Amazon_PA_Cerrado_MA/'
...
if len(result_path) == 0:
    ...
    titles = 'X=RO, Y=MA(Y1=PA,Y2=MA)\n'
    map_file = 'Multi_Target_Ts_RO_Eval_MA_'
    metrics_file = 'Metrics_Multi_Target_Ts_RO_Eval_MA_'
