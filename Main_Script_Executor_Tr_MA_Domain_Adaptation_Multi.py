...
#TARGET: PA and RO
target_dataset = AMAZON_PA.DATASET + "_" + AMAZON_RO.DATASET
source_to_target = CERRADO_MA.DATASET + "_to_" + target_dataset

DR_LOCALIZATION = ['55']
METHODS  = ['DeepLab']
DA_TYPES = ['DR']
DATASETS = [AMAZON_PA.DATASET, AMAZON_RO.DATASET]
