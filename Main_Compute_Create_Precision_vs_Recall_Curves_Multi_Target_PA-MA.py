...
result_path = [
    ...
    main_path + 'results_tr_Amazon_PA_to_Amazon_RO_Cerrado_MA_domain_adaptation_DR_CONV_multi_balanced_domain_labels_True_Cerrado_MA/',
...
labels = [
    ...
    'Tr: PA->RO,MA Ts: MA (domain adaptation multi-target 3 neurons conv discriminator)',    
...
for i in range(0, len(result_path), 5):
    ...
    title = 'Multi_Target_Ts_PA_Eval_MA_'+str(cont)
