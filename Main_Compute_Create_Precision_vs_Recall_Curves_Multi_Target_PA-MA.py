...
single_target_path = 'results_tr_Amazon_PA_to_Cerrado_MA_domain_adaptation_DR_FC_single_Cerrado_MA/'
...
if len(result_path) == 0:
    titles = 'X=PA, Y=MA->PA\n'
    map_file = 'Single_Target_Ts_PA_Eval_MA_'
    metrics_file = 'Metrics_Single_Target_Ts_PA_Eval_MA_'
