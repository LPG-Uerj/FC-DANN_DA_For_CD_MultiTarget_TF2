...
result_path = [
    ...
    main_path + 'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_CONV_multi_balanced_domain_labels_True_Amazon_PA/',
...
labels = [
    ...
    'Tr: RO->PA,MA Ts: PA (domain adaptation multi-target 3 neurons conv discriminator)',    
...
for i in range(0, len(result_path), 5):
    ...
    title = 'Multi_Target_Ts_RO_Eval_PA_'+str(cont)
