...
single_target_path = 'results_tr_Amazon_RO_to_Amazon_PA_domain_adaptation_CL_DR_single_Amazon_PA_wrmp1_gamma_2.5_skipconn_True/'
single_target_checkpoint = 'checkpoint_tr_Amazon_RO_to_Amazon_PA_domain_adaptation_CL_DR_single_Amazon_PA_gamma_2.5_skipconn_True/'

result_path = [    
    'results_tr_Amazon_RO_to_Amazon_PA_Cerrado_MA_domain_adaptation_DR_FC_multi_discriminate_target_True_wrmp_1_Amazon_PA/'
