...
labels.append('3-Tr: RO->PA,MA Ts: PA (domain adaptation multi-target)')
labels.append('4-Tr: RO->PA,MA(blcd) Ts: PA (domain adaptation multi-target)')
...
labels.append('7-Tr: RO,Ts: PA (Source only training)')
