...
single_target_path = 'results_tr_Amazon_RO_to_Amazon_PA_domain_adaptation_DR_FC_single_Amazon_PA/'
single_target_checkpoint = 'checkpoint_tr_Amazon_RO_to_Amazon_PA_domain_adaptation_DR_FC_single_Amazon_PA/'
...
if len(result_path) == 0:
    titles = 'X=RO, Y=PA->RO\n'
    map_file = 'Single_Target_Ts_RO_Eval_PA_'
    metrics_file = 'Metrics_Single_Target_Ts_RO_Eval_PA_'
