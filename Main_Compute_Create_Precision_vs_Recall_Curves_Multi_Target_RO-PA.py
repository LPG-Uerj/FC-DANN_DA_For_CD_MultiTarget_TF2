...
upper_bound_da_label = 'Tr:RO->PA,MA Ts:PA\n(DA training on multi-target)'
...
single_target_label = 'Tr:RO->PA Ts:PA\n(DA single-target)'
...
for i in range(0, len(result_path)):
    ...
    title = "Metrics_Multi_Target_Ts_RO_Eval_PA_"+str(cont)
