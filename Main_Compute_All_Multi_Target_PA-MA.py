...
baseline_labels = [
    ...
    SharedParameters.formatted_multi_target_label("PA","MA","RO","MA") + " " + SharedParameters.EXPERIMENTS_LABELS[0],
    SharedParameters.formatted_multi_target_label("PA","MA","RO","MA") + " " + SharedParameters.EXPERIMENTS_LABELS[1],
