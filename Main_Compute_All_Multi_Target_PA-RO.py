...
baseline_labels = [
    ...
    SharedParameters.formatted_multi_target_label("PA","MA","RO","RO") + " " + SharedParameters.EXPERIMENTS_LABELS[0],
    SharedParameters.formatted_multi_target_label("PA","MA","RO","RO") + " " + SharedParameters.EXPERIMENTS_LABELS[1],
...
Charts.create_all_charts(args, baseline_paths,baseline_labels,baseline_checkpoints,titles, map_file,metrics_file,num_samples,target,'results_tr_Amazon_RO_classification_S_Amazon_RO_T_Amazon_RO/')
