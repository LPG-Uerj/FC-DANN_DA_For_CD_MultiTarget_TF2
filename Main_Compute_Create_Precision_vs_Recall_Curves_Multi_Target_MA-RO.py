...
single_target_path = 'results_tr_Cerrado_MA_to_Amazon_RO_domain_adaptation_DR_FC_single_Amazon_RO/'
single_target_checkpoint = 'checkpoint_tr_Cerrado_MA_to_Amazon_RO_domain_adaptation_DR_FC_single_Amazon_RO/'
...
if len(result_path) == 0:
    titles = 'X=MA, Y=RO->MA\n'
    map_file = 'Single_Target_Ts_MA_Eval_RO_'
    metrics_file = 'Metrics_Single_Target_Ts_MA_Eval_RO_'
