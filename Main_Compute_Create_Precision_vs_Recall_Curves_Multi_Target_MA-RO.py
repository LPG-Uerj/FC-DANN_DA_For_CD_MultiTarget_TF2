...
result_path = [
    ...
    main_path + 'results_tr_Cerrado_MA_to_Amazon_RO_Amazon_PA_domain_adaptation_DR_CONV_multi_balanced_domain_labels_True_Amazon_RO/',
...
labels = [
    ...
    'Tr: MA->RO,PA Ts: RO (domain adaptation multi-target 3 neurons conv discriminator)',    
