...
baseline_labels = [
    ...
    SharedParameters.formatted_multi_source_label("MA","RO","PA") + " " + SharedParameters.EXPERIMENTS_LABELS[0],
    SharedParameters.formatted_multi_source_label("MA","RO","PA") + " " + SharedParameters.EXPERIMENTS_LABELS[1],
]
...
map_file = f'{SharedParameters.DA_MULTI_SOURCE_FILE_TITLE}_Ts_RO_Eval_PA'
metrics_file = f'Metrics_{SharedParameters.DA_MULTI_SOURCE_FILE_TITLE}_Ts_RO_Eval_PA'
...
Charts.t_test(f'{baseline_labels[3]} vs Lower baseline',f1_mean[1],f1_std[1],f1_mean[2],f1_std[2], n=5)
