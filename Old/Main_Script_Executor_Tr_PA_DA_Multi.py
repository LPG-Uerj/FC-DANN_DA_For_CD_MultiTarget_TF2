...
for dr_localization in DR_LOCALIZATION:
    for method in METHODS:
        for da in DA_TYPES:
            ...
            checkpoint_dir_param = checkpoint_dir + training_type + "_" + da + "_multi_" + target_dataset
            ...
            for target_ds in TARGET_DATASETS:
                ...
                results_dir_param = results_dir + training_type + "_" + da + "_multi_" + target_ds
