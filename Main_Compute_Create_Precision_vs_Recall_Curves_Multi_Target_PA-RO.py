...
upper_bound_da_label = 'Tr:PA->RO,MA Ts:RO\n(DA training on multi-target)'
...
single_target_label = 'Tr:PA->RO Ts:RO\n(DA single-target)'
...
for i in range(0, len(result_path)):
    ...
    title = "Metrics_Multi_Target_Ts_PA_Eval_RO_"+str(cont)
