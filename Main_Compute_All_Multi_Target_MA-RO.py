...
baseline_labels = [
    ...
    SharedParameters.formatted_multi_target_label('MA','PA','RO','RO') + " " + SharedParameters.EXPERIMENTS_LABELS[0],
    SharedParameters.formatted_multi_target_label('MA','PA','RO','RO') + " " + SharedParameters.EXPERIMENTS_LABELS[1],
