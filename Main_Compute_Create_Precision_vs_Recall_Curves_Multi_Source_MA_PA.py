...
titles = 'X=MA,PA Y=RO\n'
map_file = 'Multi_Source_Ts_MA_PA_Eval_RO_'
metrics_file = 'Metrics_Multi_Source_Ts_MA_PA_Eval_RO_'
for i in range(0, len(result_path)):
    result_path_ = baseline_paths + [result_path[i]]
    labels_ = baseline_labels + [SharedParameters.formatted_multi_source_label('MA','PA','RO')]
