...
DA_TYPES = ['DR']
TARGET_DATASETS = [AMAZON_RO.DATASET, CERRADO_MA.DATASET]

for dr_localization in DR_LOCALIZATION:
    for method in METHODS:
        for da in DA_TYPES:
            
            checkpoint_dir_param = checkpoint_dir + training_type + "_" + da + "_" + domain_regressor_type + "_multi_discriminate_target_" + str(args.discriminate_domain_targets) + "_wrmp_" + warmup + "_" + target_dataset + "_skipconn_" + SharedParameters.SKIP_CONNECTIONS
            ...
            for target_ds in TARGET_DATASETS:
                ...
                results_dir_param = results_dir + training_type + "_" + da + "_" + domain_regressor_type + "_multi_discriminate_target_" + str(args.discriminate_domain_targets) + "_wrmp_" + warmup + "_" + target_ds + "_skipconn_" + SharedParameters.SKIP_CONNECTIONS
