...
for dr_localization in DR_LOCALIZATION:
    for method in METHODS:
        for da in DA_TYPES:
            ...
            checkpoint_dir_param = checkpoint_dir + training_type + "_uncertainty_" + target_dataset
            
            uncertainty_dir_param = os.path.join(SharedParameters.AVG_MAIN_PATH, results_dir + training_type + "_S_" + source_dataset + "_T_" + source_dataset, 'Avg_Scores')
            ...
            for target_ds in DATASETS:
                ...
                results_dir_param = results_dir + training_type + "_uncertainty_" + "_S_" + source_dataset + "_T_" + target_ds
